...
/**
 * Regression tests for pubchem-mcp-server structuredContent responses.
 */
...
if (index) {
  assertContains('src/index.ts', index, 'PubchemDataDO', 'index exports PubchemDataDO');
...
if (codeMode) {
  assertContains('src/tools/code-mode.ts', codeMode, 'pubchem_search', 'code-mode registers pubchem_search');
  assertContains('src/tools/code-mode.ts', codeMode, 'pubchem_execute', 'code-mode registers pubchem_execute');
}

if (queryData) {
  assertContains('src/tools/query-data.ts', queryData, 'pubchem_query_data', 'registers pubchem_query_data');
}

if (getSchema) {
  assertContains('src/tools/get-schema.ts', getSchema, 'pubchem_get_schema', 'registers pubchem_get_schema');
}
